            ...
            <div className="row justify-content-center">
                ...
                <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 py-4">
                    ...
                    <div className="d-flex justify-content-between py-3">
                        <button onClick={() => emptyCart()} className="btn btn-outline-danger">Limpar carrinho</button>
                        <h3>Valor total: R${cartTotal}</h3>
                        <div className="d-flex justify-content-end">
                            <button onClick={(e) => e.preventDefault()} className="btn btn-outline-success">Finalizar compra</button>
                        </div>
                    </div>
                </div>
            </div>
